...
public class Guardian implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        Guardian other = (Guardian) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getGuardianName() == null ? other.getGuardianName() == null : this.getGuardianName().equals(other.getGuardianName()))
            && (this.getGuardianTel() == null ? other.getGuardianTel() == null : this.getGuardianTel().equals(other.getGuardianTel()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGuardianTel() == null) ? 0 : getGuardianTel().hashCode());
